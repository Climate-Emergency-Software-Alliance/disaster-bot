...
module.exports = ({ requestBody, currentWABA_ID }) => {
    ...
    let contacts = requestBody.entry[0].changes[0].value?.whatsapp_business_api_data?.contacts?.length
        ? requestBody.entry[0].changes[0].value?.whatsapp_business_api_data?.contacts[0]
        : null;
    // Messages vs Notifications
    let message = requestBody.entry[0].changes[0].value?.whatsapp_business_api_data?.messages?.length
        ? requestBody.entry[0].changes[0].value?.whatsapp_business_api_data?.messages[0]
        : requestBody.entry[0].changes[0].value?.messages?.length ? requestBody.entry[0].changes[0].value?.messages[0] : null;

    let notificationMessage = requestBody.entry[0].changes[0].value?.whatsapp_business_api_data?.statuses?.length
        ? requestBody.entry[0].changes[0].value?.whatsapp_business_api_data?.statuses[0]
        : requestBody.entry[0].changes[0].value?.statuses?.length ? requestBody.entry[0].changes[0].value?.statuses[0] : null;
